...
export default function Approved({ handleUnapprovedStatus, handleApprovedStatus, setTestimonials, testimonials }) {

  useEffect(() => {

    const getTestimonials = async () => {
      try {
        const response = await fetch('http://localhost:8000/testimonials/approved', {
          method: 'GET',
          headers: {
