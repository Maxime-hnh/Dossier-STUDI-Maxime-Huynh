...
export default function AllTestimonials({handleUnapprovedStatus, handleApprovedStatus, setTestimonials, testimonials, token}) {

  useEffect(() => {

    const getTestimonials = async () => {
      try {
        const response = await fetch('http://localhost:8000/testimonials/all', {
          method: 'GET',
          headers: {
