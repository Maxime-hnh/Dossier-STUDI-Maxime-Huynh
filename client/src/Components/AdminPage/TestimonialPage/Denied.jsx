...
export default function Denied({ handleUnapprovedStatus, handleApprovedStatus, setTestimonials, testimonials, token }) {
    ...
    useEffect(() => {
        ...
        const getTestimonials = async () => {
            try {
                const response = await fetch('/testimonials/unapproved', {
                    method: 'GET',
                    headers: {
            ...
            <div className="column is-12">
                ...
                <div className="columns is-multiline is-1 is-justify-content-center">
                    {testimonials && testimonials.map((testimonial, index) => (
                        ...
                        <div key={index} className="mt-4 mr-5 card column is-one-third-fullhd is-one-quarter-widescreen is-half-desktop is-9-tablet is-full-mobile p-0">
